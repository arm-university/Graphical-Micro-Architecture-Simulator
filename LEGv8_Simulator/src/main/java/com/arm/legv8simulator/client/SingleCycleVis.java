...
public class SingleCycleVis {
    ...
    public void updateDatapath(Instruction ins, boolean branchTaken, boolean stxrSucceed, int instructionIndex, String label) {
        ...
        switch (m.type) {
            ...
            case DMNEMONIC_RR:
            case XMNEMONIC_RRR:
                drawDatapathRRR(m.equals(Mnemonic.ADDS) || m.equals(Mnemonic.SUBS) || m.equals(Mnemonic.ANDS)
                        || m.equals(Mnemonic.FCMPS) || m.equals(Mnemonic.FCMPD), m);
                drawInstructionTextRRR(ins);
                break;
            case XMNEMONIC_RI:
            case XMNEMONIC_RRI:
                drawDatapathRRI(m.equals(Mnemonic.ADDIS) || m.equals(Mnemonic.SUBIS) || m.equals(Mnemonic.ANDIS) || m.equals(Mnemonic.CMPI), m);
